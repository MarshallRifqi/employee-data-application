<template>
  ...
  <div
    class="container-sm d-flex justify-content-center align-items-center min-vh-100 bg-card"
  >
    <!-- login -->
        ...
        >
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
              <img
                src="../assets/IMG_20241104_080642_067 (1).png "
                class="d-block w-100"
                alt="..."
              />
            </div>
