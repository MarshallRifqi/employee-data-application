                ...
                <form @submit.prevent="handleAddSubmit">
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      <div class="mb-3 col-md-12">
                        <!-- <div>Selected: {{ selected }}</div> -->
                        <label for="kode-barang" class="mb-3"
                          >Masukkan Nama Barang</label
                        >
                        <br />
                        <select
                          id="kode-barang"
                          class="form-select mb-2"
                          v-model="newBarang.id_barang"
                        >
                          <option disabled value="">Pilih barang</option>
                          <!-- <option value="{{barangMsk.id_barang}}" v-if="barangMsk.barang">{{ barangMsk.barang.nama_barang }}</option> -->
                          <option
                            :value="barang.id_barang"
                            v-for="barang in masterbarangList"
                    ...
                    <div class="row">
                      <div class="mb-3 col-md-5">
                        ...
                        <input
                          ...
                          class="form-control"
                          id="tanggal"
                          v-model="newBarang.tanggal_masuk"
                        />
                      </div>
                      <div class="mb-3 col-md-7">
                        <label for="stok" class="col-form-label"
                          >Jumlah masuk stok</label
                        >
                        <input
                          type="number"
                          class="form-control"
                          id="stok"
                          v-model="newBarang.kuantitas"
                          min="0"
                          max="1000"
                        />
                      </div>
      ...
      <div class="card border table-shadow m-4 p-3">
        ...
        <div class="card-body">
          <table class="table table-bordered" width="100%" id="example">
            ...
            <tbody class="danger">
              <tr
                v-for="(barangMsk, index) in barangList"
                :key="barangMsk.id_barang_masuk"
              >
                ...
                <td>
                  ...
                  <button
                    ...
                    @click="confirmDelete(barangMsk.id_barang_masuk)"
                  >
          ...
          <div class="modal-body">
            <form @submit.prevent="handleEditSubmit">
              <div class="container-fluid">
                <div class="row">
                  <div class="mb-3 col-md-12">
                    <label for="kode-barang" class="col-form-label"
                      >Masukan kode barang</label
                    >
                    <input
                      type="text"
                      class="form-control"
                      id="kode-barang"
                      v-model="editBarang.id_barang_masuk"
                      readonly
                    />
                  </div>
                </div>
                <div class="row">
                  <div class="mb-3 col-md-5">
                    ...
                    <input
                      ...
                      class="form-control"
                      id="tanggal"
                      v-model="editBarang.tanggal_masuk"
                    />
                  </div>
                  <div class="mb-3 col-md-7">
                    <label for="stok" class="col-form-label"
...
const handleEditSubmit = async () => {
  try {
    const response = await axios.patch(
      `barang-masuk/update/${editBarang.value.id_barang_masuk}`,
      {
